...
func (g *Group) PushUpdate(ctx context.Context, userId int64) error {
	userResp, err := rpc.GetUserIntClient().GetUser(ctx, &pb.GetUserReq{UserId: userId})
	if err != nil {
		return err
	}
...
func (g *Group) GetMembers(ctx context.Context) ([]*pb.GroupMember, error) {
	...
	resp, err := rpc.GetUserIntClient().GetUsers(ctx, &pb.GetUsersReq{UserIds: userIds})
	if err != nil {
		return nil, err
	}
...
func (g *Group) PushAddMember(ctx context.Context, optUserId int64, addedIds []int64) error {
	...
	usersResp, err := rpc.GetUserIntClient().GetUsers(ctx, &pb.GetUsersReq{UserIds: addIdMap})
	if err != nil {
		return err
	}
...
func (g *Group) PushDeleteMember(ctx context.Context, optId, userId int64) error {
	userResp, err := rpc.GetUserIntClient().GetUser(ctx, &pb.GetUserReq{UserId: optId})
	if err != nil {
		return err
	}
